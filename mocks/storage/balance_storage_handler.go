...
func (_m *BalanceStorageHandler) NewAccountsReconciled(ctx context.Context, dbTx storage.DatabaseTransaction, count int) error {
	ret := _m.Called(ctx, dbTx, count)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, storage.DatabaseTransaction, int) error); ok {
...
func (_m *BalanceStorageHandler) NewAccountsSeen(ctx context.Context, dbTx storage.DatabaseTransaction, count int) error {
	ret := _m.Called(ctx, dbTx, count)
